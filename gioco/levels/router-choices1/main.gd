...
var dst_ip
const malicious_texture = "res://levels/router-choices1/packets/malicious-mail.png"
...
func set_random_icon(pkt: Sprite2D) -> void:
	if pkt.texture == null:
		...
		var icon_path = "res://levels/router-choices1/packets/mail-" + str(random_index) + ".png"
